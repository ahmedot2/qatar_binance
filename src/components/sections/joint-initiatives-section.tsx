...
export function JointInitiativesSection() {
    return (
        <Section id="initiatives" className="bg-background">
            <h2 className="section-title">VI. Key Pillars of the Partnership</h2>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {pillars.map((item, index) => (
                    <Card key={index} className="group relative overflow-hidden flex flex-col hover:shadow-primary/20 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
