                            ...
                            <div key={hub.hub} className="rounded-lg border bg-card/50 p-4">
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center">
                                        ...
                                        {hub.ownership ? <CheckCircle2 strokeWidth={1.5} className="w-5 h-5 text-green-500" aria-hidden="true" /> : <XCircle strokeWidth={1.5} className="w-5 h-5 text-destructive" aria-hidden="true" />}
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-sm text-muted-foreground">100% Profit Repatriation</span>
                                        {hub.repatriation ? <CheckCircle2 strokeWidth={1.5} className="w-5 h-5 text-green-500" aria-hidden="true" /> : <XCircle strokeWidth={1.5} className="w-5 h-5 text-destructive" aria-hidden="true" />}
                                    </div>
                                    <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex justify-between items-center">
                                     ...
                                     <div className="flex justify-between items-center">
                                        ...
                                        {hub.incentives ? <CheckCircle2 strokeWidth={1.5} className="w-5 h-5 text-green-500" aria-hidden="true" /> : <XCircle strokeWidth={1.5} className="w-5 h-5 text-destructive" aria-hidden="true" />}
                                    </div>
                                </div>
                            </div>
                        ))}
                        ...
                        <Table>
                            ...
                            <TableBody>
                                <TableRow>
                                    ...
                                    <TableCell className="text-center"><CheckCircle2 strokeWidth={1.5} className="w-5 h-5 text-green-500 mx-auto" aria-hidden="true" /></TableCell>
                                    <TableCell className="text-center"><CheckCircle2 strokeWidth={1.5} className="w-5 h-5 text-green-500 mx-auto" aria-hidden="true" /></TableCell>
                                    <TableCell className="text-center"><CheckCircle2 strokeWidth={1.5} className="w-5 h-5 text-green-500 mx-auto" aria-hidden="true" /></TableCell>
                                </TableRow>
                                <TableRow>
