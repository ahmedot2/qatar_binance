                ...
                <Card className="lg:col-span-4">
                    ...
                    <CardContent className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        <div className="stat-card">
                            <BarChart strokeWidth={1.5} className="w-10 h-10 text-primary mb-2" aria-hidden="true" />
                        ...
                        <div className="stat-card">
                            <Users strokeWidth={1.5} className="w-10 h-10 text-primary mb-2" aria-hidden="true" />
